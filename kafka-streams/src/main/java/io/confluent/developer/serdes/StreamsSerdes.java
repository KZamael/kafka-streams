...
public class StreamsSerdes {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Add the correct key and value Serdes so Kafka Streams can consume from the topic, that means Consumed.with(Serdes.String(), ...)
        ...
        firstStream.filter((key, value) -> value.contains(orderNumberStart))
                ...
                // Add the correct key and value Serdes to write out to a topic, same with Consumed.with above in the KStream!
